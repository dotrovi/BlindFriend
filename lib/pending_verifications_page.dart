...
class _PendingVerificationsPageState extends State<PendingVerificationsPage> {
              ...
              return Column(
                children: docs.map((doc) {
                  ...
                  return _VolunteerRow(
                    ...
                    isWide: isWide,
                    onTap: (enrichedData) => _showDetailsShell(context, enrichedData, isWide),
                  );
                }).toList(),
              );
            },
  ...
  // ---------------------------------------------------------------------------
  // INTERACTIVE DETAILS INTERFACE SWITCHER
  // ---------------------------------------------------------------------------

  void _showDetailsShell(BuildContext context, Map<String, dynamic> data, bool isWide) {
    if (isWide) {
      showDialog(
        context: context,
        builder: (ctx) => Dialog(
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              ...
              child: _buildModalShellLayout(ctx, data),
            ),
          ),
        ),
      );
  ...
  Widget _buildModalShellLayout(BuildContext ctx, Map<String, dynamic> data) {
    final uid = data['uid'] ?? '';
    ...
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Drawer Handle Pill Accent for Mobile layout
        Center(
          child: Container(
            width: 36,
            height: 4,
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailCard('Volunteer Information', [
                  ...
                  _detailRow(
                      'Specialties:',
                      specialties.isNotEmpty ? specialties.join(', ') : 'None'),
                ]),
              ],
            ),
          ),
          ...
          return Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  value,
                  style: const TextStyle(fontSize: 13, color: Colors.white70, height: 1.2),
                ),
              ),
            ],
          );
